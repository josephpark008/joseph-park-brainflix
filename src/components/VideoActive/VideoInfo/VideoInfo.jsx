...
export default function VideoInfo(props) {
  ...
  // const {channel, timestamp, title} = videoData
...
<div className="video-numbers">
        <div className="view-details">
          <img className="view-details__icon" src={ViewsIcon} alt="views icon" />
          <p className="view-details__count">{views}</p>
        </div>

        <div className="likes-details">
          <img className="likes-details__icon" src={LikesIcon} alt="likes icon" />
